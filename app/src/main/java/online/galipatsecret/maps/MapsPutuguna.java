package online.galipatsecret.maps;
...
import online.galipatsecret.maps.api.ApiClient;
import online.galipatsecret.maps.api.ApiService;
import online.galipatsecret.maps.model.ListLocationModel;
import online.galipatsecret.maps.model.LocationModel;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class MapsPutuguna extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_putuguna);
    ...
    private void getAllDataLocationLatLng(){
        ...
        call.enqueue(new Callback<ListLocationModel>() {
            ...
            public void onFailure(Call<ListLocationModel> call, Throwable t) {
                dialog.dismiss();
                Toast.makeText(MapsPutuguna.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
